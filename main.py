...
from webscrape import scrape_webpage  # Updated import for web scraping
import validators
import faiss
...
if not st.session_state.preprocessing_done:
        ...
        if doc_path or links:
            with st.spinner("Processing... This may take a while."):
                try:
                    ...
                    if links:
                        for link in links:
                            scraped_text = scrape_webpage(link)  # Using Requests + BeautifulSoup
    ...
    # Create columns for displaying the vector databases
    cols = st.columns(5)
